...
def draw():
    ...
    fill(255, 0, 0)
    ellipse(X, Y, puckRadius * 2, puckRadius * 2)  # Puck
    fill(237, 131, 50)
    ...
    if (Y < puckRadius and X < 125) or (Y < puckRadius and X > 275) :
     speedY = speedY * -1
    elif(Y < puckRadius and X > 125 and X < 275):
     puckInPlay = False
     print("GOAL")
     
    if (Y == 580 and (X > mouseX - 50 and X < mouseX + 50)):
     speedY = speedY * -1
